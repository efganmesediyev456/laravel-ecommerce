		...
		<div class=" main-content-area">
			...
			<div class="summary summary-checkout">
				<div class="summary-item payment-method">
					...
					<div style="color:green;font-size:48px; display:none;" id="process">
						<i class="fa fa-spinner fa-pulse"></i>Processing...
					</div>

					@endif
					<a href="#" class="btn btn-medium" wire:click.prevent="odeme" onclick="$('#process').show()">Place order now</a>
				</div>
