        ...
        <div class="row">
                ...
                <div class="wrap-shop-control">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="choseFilter">
                        ...
                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model="countFilter">
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 last">
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price">${{ $product->sale_price }}</span> <del>${{ $product->regular_price }}</del></div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                    ...
                    <div class="widget-content">
                        <ul class="list-category">
                            ...
                            <li class="category-item">
                                <a href="{{ route('category.product',['category'=>$cat->slug]) }}" class="cate-link">{{ $cat->name }}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="widget mercado-widget filter-widget price-filter">
                    <h2 class="widget-title">Price ${{ $slider_min }} --- ${{ $slider_max }}</h2>
...
<script>
    ...
    slider.noUiSlider.on('update', function(value) {
        @this.set('slider_min', value[0])
        @this.set('slider_max', value[1])
    })
</script>
