...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('assets\images\blogs\blog-article-1.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('assets\images\blogs\blog-article-1.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('admin.add.slider') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Slider Create</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{ route('admin.country.product') }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
